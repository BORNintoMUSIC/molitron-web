    ...
    <Section tone="white" noReveal>
      <div className="mx-auto max-w-2xl py-16 text-center">
        ...
        <h1 className="mt-4 font-display text-4xl font-semibold text-primary sm:text-5xl">
          That page is not in the current site.
        </h1>
        <p className="mt-5 text-base leading-relaxed text-muted">
          Use the product and resource paths below, or contact Molitron if you were looking for a
          technical document or legacy-equipment reference.
        </p>
