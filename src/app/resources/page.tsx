  ...
  return (
    <>
      ...
      <Section id="additional-resources" tone="white">
        <SectionHeading eyebrow="More guidance" title="Listings & service" />
        <div className="grid gap-8 md:grid-cols-2">
          ...
          <Link href="/service-parts" className="online-guide">
            <div>
              ...
              <h3>Service, parts & legacy equipment</h3>
              <p>Includes discontinued Enviro-Clean references.</p>
            </div>
            <Arrow diagonal />
          </Link>
        </div>
      ...
      <CtaBand
        ...
        description="Share the product, model and question."
      />
    </>
  );
}
