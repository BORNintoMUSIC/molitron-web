...
const hero = {
  ...
  breadcrumbs: [
    ...
    { label: "Installation planning", href: path },
  ],
};
...
const technicalData = [
  ...
  [
    "Maximum nozzle-line length",
    "100 ft; final routing and installation are project-specific",
  ],
  [
    "Nozzle-line conduit",
    "1 in. recommended; not a universal code requirement",
  ],
  [
    "Two-nozzle capacity",
  ...
  [
    "Low-solution alarm point",
    "Below 2 gal.; operating reference, not a precision measurement guarantee",
  ],
] as const;
...
const projectRoles = [
  [
    "Owner or operator",
    "Provide current cooking, operating, site, access, and schedule information.",
  ],
  [
  ...
  [
    "Qualified installer",
    "Use current controlled project and installation information for the authorized work.",
  ],
  [
  ...
  [
    ...
    "Determine project acceptance under requirements applicable to the project location.",
  ],
  [
    "Molitron",
    "Provide product information and project-specific application review.",
  ],
] as const;
  ...
  return (
    <article className="guide-reading">
      ...
      <SectionNav
        label="In this guide"
        items={[
          { href: "#project-inputs", label: "Project inputs" },
          { href: "#system-coordination", label: "System layout" },
        ...
        <div className="grid gap-5 lg:grid-cols-[1.35fr_0.65fr]">
          <div className="rounded-lg border border-warning/35 bg-accent-soft px-5 py-5">
            ...
            <p className="mt-3 max-w-3xl text-sm leading-relaxed text-foreground/80 sm:text-base">
              This guide helps owners and facility managers organize a MOAS
              project and gives engineers, architects, contractors, service
              personnel, and AHJs a common planning reference. It is not a
              construction drawing, wiring diagram, startup procedure,
      ...
      <Section id="project-inputs" tone="white">
        <SectionHeading
        ...
        <div className="grid gap-5 lg:grid-cols-2">
          <article className="surface-card surface-card-static p-5 sm:p-6">
            <h3 className="text-lg font-semibold text-primary">
              Cooking and exhaust information
            </h3>
            <ul className="mt-4 list-disc space-y-2 pl-5 text-sm leading-relaxed text-foreground/80">
              ...
              <li>
                Hood arrangement, exhaust airflow, duct route, and fan
                arrangement.
              </li>
              <li>
                Discharge location and available path from the proposed nozzles
                to discharge.
              </li>
              <li>
                Nearby air intakes, occupied areas, property lines, and other
                sensitive receptors.
              </li>
            </ul>
          </article>
          <article className="surface-card surface-card-static p-5 sm:p-6">
            ...
            <ul className="mt-4 list-disc space-y-2 pl-5 text-sm leading-relaxed text-foreground/80">
              <li>
                Project name, address, jurisdiction, status, and anticipated
                schedule.
              </li>
              <li>
                New construction, remodel, or existing-system modification.
              </li>
              <li>
                Design professional, installing contractors, service contact,
                and AHJ contacts.
              </li>
              <li>
              ...
              <li>
                Access for installation, inspection, refilling, startup, and
                future service.
              </li>
            </ul>
          </article>
      ...
      <Section id="system-coordination">
        <SectionHeading
        ...
        <ol className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          {[
            [
              "01",
              "Exhaust path",
              "Coordinate the hood, duct, fan, discharge, and available path after the nozzle location.",
            ],
            [
              "02",
              "Two remote nozzles",
              "Locate the misting nozzles through project-specific review; preserve access to the duct interface.",
            ],
            [
              "03",
              "Separate tubing",
              "Route 1/4-in. OD solution tubing and 3/8-in. OD air tubing back to the cabinet.",
            ],
            [
              "04",
        ...
        <div className="mt-6 rounded-lg border border-border bg-card p-5 sm:p-6">
          <h3 className="text-lg font-semibold text-primary">
            Exhaust-fan interlock intent
          </h3>
          <p className="mt-2 max-w-4xl text-sm leading-relaxed text-foreground/80">
            MOAS is intended not to operate when the exhaust fan is off.
            Qualified electrical personnel must coordinate the actual fan-status
            signal, control or relay function, dedicated supply, and authorized
            installation information. The planning guide does not provide relay
            terminals, conductor colors, line/load connections, or construction
            wiring.
          </p>
        </div>
      </Section>
      ...
      <Section id="technical-data" tone="white">
        ...
        <div
          tabIndex={0}
          role="region"
          aria-label="MOAS guide technical reference"
        ...
        >
          <table className="w-full min-w-[44rem] text-left text-sm">
            <thead className="bg-brand text-on-brand">
              <tr>
                <th className="w-[32%] px-4 py-3 font-semibold sm:px-5">
                  Item
                </th>
        ...
        <p className="mt-4 max-w-4xl text-sm leading-relaxed text-muted">
          Product listing does not establish project approval, code approval,
          suitability, or AHJ acceptance for a particular installation. The
          up-to capacity value is not a guaranteed result for every project.
        </p>
      </Section>
      ...
      <Section id="responsibilities">
        ...
        >
          <table className="w-full min-w-[44rem] text-left text-sm">
            <thead className="bg-brand text-on-brand">
              <tr>
                <th className="w-[30%] px-4 py-3 font-semibold sm:px-5">
                  Participant
                </th>
                <th className="px-4 py-3 font-semibold sm:px-5">
        ...
        <div className="mt-6 grid gap-5 lg:grid-cols-2">
          <div className="rounded-lg border border-warning/35 bg-accent-soft p-5">
            ...
            <p className="mt-2 text-sm leading-relaxed text-foreground/80">
              MOAS is permanently connected electrical equipment. The cabinet
              contains no user-serviceable parts. Electrical-shock and
              hot-surface hazards may remain inside the equipment. Employer
              programs, qualified personnel, and current controlled instructions
          ...
          <div className="rounded-lg border border-border bg-card p-5">
            ...
            <p className="mt-2 text-sm leading-relaxed text-foreground/80">
              ...
              penetration, fabrication, sealing, plumbing, controls, wiring,
              startup, and service require current controlled project
              information. Diagrams are educational and not to scale unless a
      ...
      <Section tone="accent">
        <div className="grid items-center gap-6 lg:grid-cols-[1fr_auto]">
          <div>
            ...
            <p className="mt-3 max-w-3xl text-sm leading-relaxed text-foreground/80 sm:text-base">
              Rev A includes the system overview, cabinet and optional-container
              planning views, nozzle and duct interface, exhaust-fan interlock
              function, consolidated field-planning reference, controlled
