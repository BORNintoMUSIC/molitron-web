...
const controlledData = [
  ...
  [
    "Initial EPFA resistance",
    "1.54 in. w.g.; add hood, duct, discharge, and other system losses",
  ],
  [
    "Monitoring supply",
    "120 VAC; no circuit-amperage value is established by this manual",
  ],
  ["Running indication", "Green indication closes at 1.5 in. w.g."],
  [
    "Service indication",
    "Red indication at the selected 2–5 in. w.g. high-static setting",
  ],
  ...
  [
    "Routine interval",
    "Inspect and service every four weeks; respond immediately to a flashing red service indication",
  ],
] as const;
...
export default function EpfaOperationMaintenancePage() {
  ...
  return (
    <article className="guide-reading">
        ...
        <div className="grid gap-5 lg:grid-cols-[1.35fr_0.65fr]">
          <div className="rounded-lg border border-warning/35 bg-accent-soft px-5 py-5">
            ...
            <p className="mt-3 max-w-3xl text-sm leading-relaxed text-foreground/80 sm:text-base">
              This companion helps owners, facility managers, operators,
              installers, service personnel, engineers, and AHJs find the
              manual&apos;s essential information online. It does not replace
              unit labels, current project documents, qualified work, permits,
              testing, or AHJ review.
            </p>
          </div>
      ...
      <Section id="installation" tone="white">
        <SectionHeading
        ...
        <div className="grid gap-5 lg:grid-cols-2">
          <article className="surface-card surface-card-static p-5 sm:p-6">
            ...
            <ul className="mt-4 list-disc space-y-2 pl-5 text-sm leading-relaxed text-foreground/80">
              <li>
                Confirm the model, serial number, accessories, airflow
                direction, and service side.
              </li>
              <li>
                Document shipping damage or missing items before installation.
              </li>
              <li>
                Preserve the 30-in. minimum service-side clearance and the
                applicable material clearance.
              </li>
              <li>
                Provide a same-height service platform where above-ceiling
                placement requires one.
              </li>
            </ul>
          </article>
          <article className="surface-card surface-card-static p-5 sm:p-6">
            ...
            <ul className="mt-4 list-disc space-y-2 pl-5 text-sm leading-relaxed text-foreground/80">
              <li>
                Coordinate the two bottom support channels, roof curb or
                suspension, and project anchorage.
              </li>
              <li>Complete welded inlet and outlet grease-duct connections.</li>
              <li>
                Route the three cleaning drains to the project drain and
                grease-interceptor arrangement.
              </li>
              <li>
                Complete the building sprinkler connection or optional factory
                ANSUL pre-piping path through the responsible field parties.
              </li>
            </ul>
          </article>
        </div>
      ...
      <Section id="technical-data">
        ...
        <div
          tabIndex={0}
          role="region"
          aria-label="EPFA guide technical reference"
        ...
        <p className="mt-4 max-w-4xl text-sm leading-relaxed text-muted">
          ...
          suitability, or AHJ acceptance for a particular installation. Final
          fan selection must include all system losses.
        </p>
      </Section>

      <Section id="monitoring" tone="white">
        <SectionHeading
        ...
        <div className="grid gap-5 md:grid-cols-3">
          {[
            ...
            <article
              key={title}
              className="surface-card surface-card-static p-5"
            >
      ...
      <Section id="maintenance">
        ...
        <ol className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          {[
            [
              "01",
              "Inspect",
              "Check the status indication and gauge, access doors, gaskets, filter fit, drains, and visible equipment condition.",
            ],
            [
              "02",
              "Service filters",
              "Preserve the F1/F2/F3 order, install filters individually without overlap, and maintain the documented gasket relationship.",
            ],
            [
              "03",
              "Clean safely",
              "Qualified personnel control energy, protect the controls, use the cleaning drains, steam-clean accessible stainless surfaces, inspect, and dry before return to service.",
            ],
            [
              "04",
              "Record and respond",
              "Record the date, readings, filter actions, cleaning, technician, next due date, and unresolved conditions with the equipment records.",
            ],
        ...
        <div className="mt-6 rounded-lg border border-border bg-card p-5 sm:p-6">
          <h3 className="text-lg font-semibold text-primary">
            Printable equipment records
          </h3>
          <p className="mt-2 max-w-4xl text-sm leading-relaxed text-foreground/80">
            Rev A includes a receiving record, owner acknowledgment, contractor
            pre-start checkoff, contractor identification record, factory
            startup and monitoring record, maintenance log, and a 17 × 11-in.
            installation and commissioning foldout. These are printable writing
            pages; the PDF contains no interactive form fields or hidden
            submission behavior.
          </p>
        </div>
      </Section>

      <Section id="responsibilities" tone="white">
        <SectionHeading
      ...
      <Section tone="accent">
        <div className="grid items-center gap-6 lg:grid-cols-[1fr_auto]">
          <div>
            ...
            <p className="mt-3 max-w-3xl text-sm leading-relaxed text-foreground/80 sm:text-base">
              Rev A includes the full receiving, installation coordination,
              monitoring, startup, maintenance, filter service, cleaning,
              troubleshooting, warranty, printable record, and 17 × 11-in.
              foldout content.
            </p>
          </div>
